...
الصحيح في متجر سلة من **شاشة واحدة**: اختَر **الفترة** و**المدة** من لوحة ثابتة أعلى الصفحة،
واضغط **اشترك الآن**.
...
| `src/styles.css` | CSS تصميم v2 المعتمد |
...
| `design_handoff_baqat_v2/` | تسليم التصميم المعتمد (v2) |
